      ...
      <div className="footer-mobile">
        ...
        <div className="footer-content flex">
            <div className="footer-mobile-1">
                <Image src="/images/img-mobile.png" alt="Mobile App" width="143" height="95"></Image>
            </div>
        </div>
      </div>
    </div>
    <div className="footer-bottom bg-colors-white flex flex-row justify-between mt-4 mb-4">
      <div className="text-xs flex flex-1 justify-center">
        <div className="ml-24 place-self-center justify-self-center justify-items-center justify-center">
          <Image src="/images/logo-coursera.png" alt="Logo Coursera" width="158" height="49" className="ml-8"></Image>
          <div className="font-light text-colors-grey">© 2024 Coursera Inc. All rights reserved.</div>
        </div>
      </div>
      <div className="footer-socmed flex mt-3 mr-8">
        <div className="pr-2">
          <Image src="/images/logo-facebook.png" alt="Logo Facebook" width="18" height="18"></Image>
        </div>
        <div className="pr-2">
          <Image src="/images/logo-linkedin.png" alt="Logo Linkedin" width="18" height="18"></Image>
        </div>
        <div className="pr-2 ">
          <Image src="/images/logo-instagram.png" alt="Logo Instagram" width="18" height="18"></Image>
        </div>
        <div className="pr-2">
          <Image src="/images/logo-twitter.png" alt="Logo Twitter" width="18" height="18"></Image>
        </div>
        <div className="pr-2">
          <Image src="/images/logo-youtube.png" alt="Logo Youtube" width="18" height="18"></Image>
        </div>
      </div>
    </div>
    </>
