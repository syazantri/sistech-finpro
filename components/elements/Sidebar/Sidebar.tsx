    ...
    >
      <div className="flex justify-between items-center p-4">
        ...
        <Image
          src={
            sidebarOpen
              ? "/images/icon-sidebar-open.png"
              : "/images/icon-list-sidebar.png"
          }
          alt="Toggle Sidebar"
          width={24}
          height={24}
        ...
        <div>
          {categories.map((category) => (
            <div key={category.name} className="mb-4">
              <div
                className={`ml-4 sidebar-category flex items-center gap-3 pt-8 ${
                  activeCategory === category.route
                    ? "bg-colors-coursera/20 rounded-xl h-10"
                    : ""
                }`}
              ...
              {category.hasDisclosure && disclosureOpen && sidebarOpen && (
                <div
                  className="ml-12 mt-2 text-colors-darkgrey text-base font-bold"
